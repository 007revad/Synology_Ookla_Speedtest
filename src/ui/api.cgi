...
#chown OoklaSpeedtest:OoklaSpeedtest "${SERVERS_FILE}"

SVR_STDERR="${LOG_DIR}/last_servers_stderr.log"
touch "${SVR_STDERR}"
chmod 644 "${SVR_STDERR}"
#chown OoklaSpeedtest:OoklaSpeedtest "${SVR_STDERR}"
...
servers)
    ...
    raw_output=$(timeout 120 env HOME=/var/packages/OoklaSpeedtest/home "${BIN_DIR}/${ARCH}/speedtest" \
